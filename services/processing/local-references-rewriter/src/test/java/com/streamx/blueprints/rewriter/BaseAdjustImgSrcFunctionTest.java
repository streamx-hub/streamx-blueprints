...
abstract class BaseAdjustImgSrcFunctionTest {
  ...
  protected abstract CloudEvent createOptimizedAssetPublishEvent(Image image);

  protected abstract CloudEvent createOptimizedAssetUnpublishEvent(Image image);
  ...
  private void publishOptimizedImage(Image image) {
    // given
    CloudEvent imageEvent = createOptimizedAssetPublishEvent(image);
  ...
  private void unpublishOptimizedImage(Image image) {
    // given
    CloudEvent imageEvent = createOptimizedAssetUnpublishEvent(image);
