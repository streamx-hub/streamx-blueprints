...
To support this, your mesh file can include an instance of `dependencies-rewriter` configured to handle sitemap XML files.
This instance will extract the page URLs, download and publish their HTML content,
and then pass that content to a second instance of `dependencies-rewriter`.
...
enabling multiple `dependencies-rewriter` instances to operate together as described.

## Configuration

- `streamx.blueprints.dependencies-rewriter.base-url-for-relative-paths`  
...
- `streamx.blueprints.dependencies-rewriter.processable-payload-types`  
...
- `streamx.blueprints.dependencies-rewriter.html-external-resource-xpath-selectors`  
...
- `streamx.blueprints.dependencies-rewriter.html-external-resource-url-exclusions-pattern`  
...
- `streamx.blueprints.dependencies-rewriter.xml-external-resource-xpath-selectors`  
...
- `streamx.blueprints.dependencies-rewriter.xml-external-resource-url-exclusions-pattern`  
A comma-separated list of regular expressions used to exclude certain external resource URLs (such as images) from processing.
Optional — this setting further filters the URLs found by the XPath selectors, limiting which resources are processed.


- `streamx.blueprints.dependencies-rewriter.json-external-resource-jsonpath-selectors`  
...
- `streamx.blueprints.dependencies-rewriter.json-external-resource-url-exclusions-pattern`  
A comma-separated list of regular expressions used to exclude certain external resource URLs (such as images) from processing.
Optional — this setting further filters the URLs found by the JSONPath selectors, limiting which resources are processed.


- `streamx.blueprints.dependencies-rewriter.emitted-page-type`  
...
- `streamx.blueprints.dependencies-rewriter.emitted-web-resource-type`  
...
- `streamx.blueprints.dependencies-rewriter.emitted-asset-type`  
...
- `streamx.blueprints.dependencies-rewriter.external-resource-download-timeout-milliseconds`  
