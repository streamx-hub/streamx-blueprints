...
1. Go to [GH Actions](https://github.com/streamx-hub/streamx-blueprints/actions)
2. Run [Release: Maven and Docker Artifacts](https://github.com/streamx-hub/streamx-blueprints/actions/workflows/release-maven-and-docker-artifacts.yaml)
   action on main branch.
3. Create new [GH Release](https://github.com/streamx-hub/streamx-blueprints/releases/new) based on
...
1. Go to: [Packages](https://github.com/orgs/streamx-hub/packages?repo_name=streamx-blueprints)
