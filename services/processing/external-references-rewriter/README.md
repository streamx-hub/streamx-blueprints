...
To support this, your mesh file can include an instance of `external-references-rewriter` configured to handle sitemap XML files.
...
- `streamx.blueprints.external-references-rewriter.base-url-for-relative-paths`  
...
- `streamx.blueprints.external-references-rewriter.processable-payload-types`  
...
- `streamx.blueprints.external-references-rewriter.html-external-resource-xpath-selectors`  
...
- `streamx.blueprints.external-references-rewriter.xml-external-resource-xpath-selectors`  
...
- `streamx.blueprints.external-references-rewriter.json-external-resource-jsonpath-selectors`  
...
- `streamx.blueprints.external-references-rewriter.emitted-web-resource-type`  
...
- `streamx.blueprints.external-references-rewriter.emitted-asset-type`  
...
- `streamx.blueprints.external-references-rewriter.external-resource-download-timeout-milliseconds`  
