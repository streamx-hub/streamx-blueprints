...
public class ParsedMigrationScript {
  ...
  /**
   * information about the filename of the migration script non-null
   */
  private FileNameInfo fileNameInfo;

  /**
   * the checksum of the raw migration script non-null
   */
  private int checksum;

  /**
   * Represents the HTTP request from the migration script non-null
   */
  ...
  public ParsedMigrationScript setMigrationScriptRequest(
