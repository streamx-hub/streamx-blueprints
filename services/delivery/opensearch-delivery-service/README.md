...
`streamx.blueprints.opensearch-delivery-service.migration-script-locations` property 
contains `classpath:opensearch/service-init/search-templates` or `classpath:opensearch/service-init`.


## Configuration

`streamx.blueprints.opensearch-delivery-service.allowed-json-paths` - 
...
`streamx.blueprints.opensearch-delivery-service.migration-script-locations` -
...
Opensearch Delivery Service also needs to know the localization of Opensearch. 
...
In this case, you need to provide credentials to the Opensearch Delivery Service.
...
* Opensearch Delivery Service environmental variables:
```
