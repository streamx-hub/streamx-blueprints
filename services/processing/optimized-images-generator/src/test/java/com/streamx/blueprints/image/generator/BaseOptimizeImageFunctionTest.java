...
abstract class BaseOptimizeImageFunctionTest {
  ...
  protected abstract String getEventSubjectForAssetFile(File assetFile);
  ...
  private CloudEvent createPublishAssetEvent(File assetFile) throws IOException {
    String subject = getEventSubjectForAssetFile(assetFile);
  ...
  private CloudEvent createUnpublishAssetEvent(File assetFile) {
    String subject = getEventSubjectForAssetFile(assetFile);
    return CloudEventUtils.eventWithoutData(subject, Asset.TYPE_UNPUBLISHED);
  }
