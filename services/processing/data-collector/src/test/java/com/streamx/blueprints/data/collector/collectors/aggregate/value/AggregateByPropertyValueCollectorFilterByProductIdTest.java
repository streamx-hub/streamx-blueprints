...
@QuarkusTest
@TestProfile(value = AggregateByPropertyValueCollectorFilterByProductIdTest.Configuration.class)
class AggregateByPropertyValueCollectorFilterByProductIdTest
  ...
  @Test
  void shouldFilterProductsById() throws IOException {
