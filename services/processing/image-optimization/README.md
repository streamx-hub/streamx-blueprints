...
`streamx.blueprints.image-optimization-processing-service.optimized-file-paths-pattern` - a Regular Expression
...
`streamx.blueprints.image-optimization-processing-service.optimized-image-file-name-suffix` - a suffix that will be added
...
`streamx.blueprints.image-optimization-processing-service.adjusted-page-paths-pattern` - a Regular Expression
...
The below configuration options refer to the cwebp library, used by image-optimization-processing-service internally.
...
`streamx.blueprints.image-optimization-processing-service.webp-conversion-speed` - how fast the cwebp image generation should be.
`cwebp` parameter equivalent: `-z`
Default value: `6`

`streamx.blueprints.image-optimization-processing-service.webp-conversion-quality` - specifies the compression factor while generating cwebp images.
`cwebp` parameter equivalent: `-q`
Default value: `75`

`streamx.blueprints.image-optimization-processing-service.webp-conversion-method` - specifies the compression method to use.
`cwebp` parameter equivalent: `-m`
Default value: `4`

`streamx.blueprints.image-optimization-processing-service.webp-conversion-lossless` - should the conversion of images to Webp images be loseless.
`cwebp` parameter equivalent: `-lossless`
Default value: `false`.

`streamx.blueprints.image-optimization-processing-service.webp-conversion-no-alpha` - should alpha channel be removed.
`cwebp` parameter equivalent: `-noalpha`
Default value: `false`.

`streamx.blueprints.image-optimization-processing-service.webp-conversion-multi-thread` - should the processing be performed in multiple threads.
...
``` properties
streamx.blueprints.image-optimization-processing-service.optimized-file-paths-pattern=.*(png|gif|jpg|jpeg)$
streamx.blueprints.image-optimization-processing-service.optimized-image-file-name-suffix=-optimized
streamx.blueprints.image-optimization-processing-service.adjusted-page-paths-pattern=.*
streamx.blueprints.image-optimization-processing-service.webp-conversion-speed=6
streamx.blueprints.image-optimization-processing-service.webp-conversion-quality=75
streamx.blueprints.image-optimization-processing-service.webp-conversion-method=4
streamx.blueprints.image-optimization-processing-service.webp-conversion-lossless=false
streamx.blueprints.image-optimization-processing-service.webp-conversion-no-alpha=false
streamx.blueprints.image-optimization-processing-service.webp-conversion-multi-thread=false
```
